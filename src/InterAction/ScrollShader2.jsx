...
const Scene = () => {
    ...
    useFrame(() => {
        const pages = 1;  // Total number of pages
    ...
    return (
        <>
            ...
            <mesh
                position={[0, 0, 0]} // Set initial positions with enough spacing
            ...
            <mesh
                ...
                castShadow={true}
            >  
                <boxGeometry args={[2,2,2,2]}></boxGeometry>
...
export default ScrollingShader2